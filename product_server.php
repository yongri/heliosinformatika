		...
		<div class="row">
			...
			else
			{
				$posisi=($page-1)*$batas;
											...
											$sql="SELECT * FROM product WHERE Category_id='1' ORDER BY Product_id DESC LIMIT $posisi,$batas";
											$query=mysql_query($sql);
										...
										<div class="thumbnail">
										 ...
										 <div class="productside"><?php echo $product; ?></div>
										   ...
										   <div class="buttonproduct" align="center"><a href='http://<?php echo BASE_URL; ?>/product_server_detail.php?id=<?php echo $id; ?>' class='btn btn-info btn-sm active square2' role='button'>Read More</a></div>
					...
					<div class="pagination pull-left">
						<ul class="pagination">
							...
							for($i=1;$i<=$jmlpage;$i++)
								if($i!=$page)
								{
									echo '<li><a href="http://'.BASE_URL.'/product_server.php?page='.$i.'">'.$i.'</a></li>';
								}
								else
								{
