					...
					<div class="col-lg-8">
						<div class="box">
							<div class="box-gray overviewcontent">
							  <section id="projects">
						 <?php								
										$sql="SELECT * FROM promo WHERE Category_id='1' ORDER BY Promo_id DESC LIMIT 1";
							 ...
							 <div class="media">
									...
									<!--	<img class="media-object" src="http://<?php echo BASE_URL; ?>/img/promo/<?php echo $data2['Promo_image']; ?>"width="300px" height="425px" alt="">-->
									   <ul id="thumbs" class="portfolio">
												<!-- Item Project and Filter Name -->
												<li class="col-lg-6 design" data-id="id-0" data-type="web">
													<div class="item-thumbs">
														<!-- Fancybox - Gallery Enabled - Title - Full Image -->
														<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="<?php echo $data2['Title']; ?>" href="http://<?php echo BASE_URL; ?>/img/promo/<?php echo $data2['Promo_image']; ?>">
														<span class="overlay-img"></span>
														<span class="overlay-img-thumb font-icon-plus"></span>
														</a>
														<!-- Thumb Image and Description -->
														<img  src="http://<?php echo BASE_URL; ?>/img/promo/<?php echo $data2['Promo_image']; ?>" alt="">
													</div>
												</li>
											</ul>
								...
								<div class="media-body">
										<p class="paragraph"><?php echo '<h3 class="title_event">'.$data2['Title'].'</h3>'; ?></p>
										...
										<?php 
											...
											{
												echo "<p class='paragraph'><font color='blue'></p>";
											}
											elseif($data2['End'] < date('Y-m-d'))
											{
												echo "<p class='paragraph'><font color='red'>Promo has Passed</p>"; 
											}
									} 
											else 
											{ 
											echo "<p class='paragraph'>No Promo Available</p>"; 
											}
										?>
								</div>
							</div>
