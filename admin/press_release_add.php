...
<!--content-->
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1><img src="../img/helios.png" width="50px" height="50px"> Press Release</h1>
			  ...
			  <li class="active"><i class="fa fa-dashboard"></i> Press Release</li>
            </ol>
            ...
            <div class="panel panel-primary">
					...
					<?php if ($_POST)
				{
					...
					if (empty($error))
					{
						...
						$sql="INSERT INTO news VALUES ('$news_id','$news_name','$Description','$Content','$news','$Created_at','1')";
		...
		<div class="form-group <?php echo (isset($error['err_Description'])) ? 'warning' : ''; ?>" id="descriptions">
			<label class="col-sm-2 control-label" for="Description">Headline News</label>
				<div class="col-sm-4">
		...
		<div class="form-group <?php echo (isset($error['err_Description'])) ? 'warning' : ''; ?>" id="Content">
			<label class="col-sm-2 control-label" for="Description">Content News</label>
				<div class="col-sm-4">
