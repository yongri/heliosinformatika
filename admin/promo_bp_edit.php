...
<div id="page-wrapper">
			...
			if(empty($error))
		{
			...
			{	
				...
				$sql="UPDATE promo SET Start='$Start', End='$End',Title='$Title',Promo_image='$file', Published_at='$Published_at', Category_id='1' WHERE Promo_id='{$_GET['id']}'";	
			...
			{
				$sql2="UPDATE promo SET Start='$Start', End='$End',Title='$Title', Published_at='$Published_at', Category_id='1' WHERE Promo_id='{$_GET['id']}'";	
	...
	var_dump($error);
		...
		$id = $_GET['id'];
		$sql=("SELECT * FROM promo WHERE Category_id='1' AND Promo_id='$id'") or die (mysql_error());
