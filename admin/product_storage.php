          ...
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-dashboard"></i> Dashboard</li> <span class="divider">/</span>
				<li> Product</li><li class="active">Product Storage</li>
            </ol>
			<div class="span6 pull-right">
				<a class="btn btn-small btn-primary" href="product_storage_add.php">Add Product</a>
			</div>
          </div>
        </div><!-- /.row --><br>
        <div class="row">
          <div class="col-lg-12">
			...
			else
			{
				...
				$sql="SELECT * FROM product WHERE Category_id='2' LIMIT $posisi,$batas";
				$query = mysql_query($sql);
					while($data=mysql_fetch_array($query))
					{
					  ...
					  <tr>
						...
						<td width="20%">
						<a href="product_storage_edit.php?&id=<?php echo $product_id; ?>">Edit</a> | 
						<a href="product_storage.php?&id=<?php echo $product_id; ?>">Delete</a>
						</td>
					  </tr>
					  <?php } ?>
                    </tbody>
