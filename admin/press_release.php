        ...
        <div class="row">
          <div class="col-lg-12">
			...
			<div class="span6 pull-right">
				<a class="btn btn-small btn-primary" href="press_release_add.php">Add Press Release</a>
			</div>
			</div></div><br>
			<div class="row">
          <div class="col-lg-12">
            <div class="panel panel-primary">
			  ...
			  <div class="table-responsive judul">
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
					<?php $sql="SELECT News_id, News_name FROM news WHERE Category_id='1' ORDER BY News_id DESC"; 
					...
					while($data=mysql_fetch_array($query))
					{
					 ...
					 ?>
					  <tr>
						...
						<td width="30%">
						<a href="press_release_edit.php?&id=<?php echo $news_id; ?>">Edit</a> | 
						<a href="press_release_delete.php?&id=<?php echo $news_id; ?>">Delete</a>
						</td>
					  </tr>
					  <?php } ?>
                    </tbody>
