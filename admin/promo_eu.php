        ...
        <div class="row">
          <div class="col-lg-12">
			...
			<div class="span6 pull-right">
				<a class="btn btn-small btn-primary" href="promo_eu_add.php">Add Promotion</a>
			</div>
			</div></div><br>
			<div class="row">
          <div class="col-lg-12">
            <div class="panel panel-primary">
			  ...
			  <div class="table-responsive judul">
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
					<?php $sql="SELECT Promo_id, Title FROM promo WHERE Category_id='2' ORDER BY Promo_id DESC"; 
					...
					while($data=mysql_fetch_array($query))
					{
					 ...
					 ?>
					  <tr>
						...
						<td width="30%">
						<a href="promo_eu_edit.php?&id=<?php echo $promo_id; ?>">Edit</a> | 
						<a href="promo_eu.php?&id=<?php echo $promo_id; ?>">Delete</a>
						</td>
					  </tr>
					  <?php } ?>
                    </tbody>
