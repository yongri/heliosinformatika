...
<div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
			...
			<li class="active">Product Storage</li>
            </ol>
			<div class="span6 pull-right">
				<a class="btn btn-small btn-primary" href="product_storage.php">Back</a>
			</div>
          </div>
        </div><!-- /.row --><br>
        <div class="row">
			...
			if(empty($error))
		{
			...
			{	
				...
				$sql="UPDATE product SET Product_name='$product_name',Content='$Content',Product_image='$file', Created_at='$Created_at', Category_id='2' WHERE Product_id='{$_GET['id']}'";	
			...
			{
				$sql2="UPDATE product SET Product_name='$product_name',Content='$Content', Created_at='$Created_at', Category_id='2' WHERE Product_id='{$_GET['id']}'";	
	...
	var_dump($error);
		...
		$id = $_GET['id'];
		$sql=("SELECT * FROM product WHERE Category_id='2' AND Product_id='$id'") or die (mysql_error());
