...
<!--content-->
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1><img src="../img/helios.png" width="50px" height="50px"> Press Release</h1>
			  <ol class="breadcrumb">
              <li><i class="fa fa-dashboard"></i> Press Release</li>
			  <li class="active"><i class="fa fa-dashboard"></i> Edit</li>
            </ol>
			<div class="span6 pull-right">
				<a class="btn btn-small btn-primary" href="press_release.php">Back</a>
			</div>
        </div></div><br>
			<div class="row">
          <div class="col-lg-12">
	...
	if (isset($_POST['bkirim']))
	{
		...
		if(empty($error))
		{
			...
			{	
				...
				$sql="UPDATE news SET News_name='$news_name', Description='$Description', Content='$Content', News_image='$file',Created_at='$Created_at', Category_id='1' WHERE News_id='{$_GET['id']}'";
				...
				$sql="UPDATE news SET News_name='$news_name', Description='$Description', Content='$Content',Created_at='$Created_at',Category_id='1'  WHERE News_id='{$_GET['id']}'";
				$query=mysql_query($sql); echo $sql;
				if($query)
				{
					echo "<div class='alert alert-success alert-dismissable'>
	...
	?>
		...
		<div class="form-group <?php echo (isset($error['err_Description'])) ? 'warning' : ''; ?>" id="Content">
